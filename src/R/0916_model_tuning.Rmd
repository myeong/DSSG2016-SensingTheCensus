...
ggplot(data=c1, aes(x=time, y=c1, group=day,colour=factor(day))) + geom_line(size =2) + xlab("\nTime Index") + ylab("") + ylim(0,0.012) + theme_bw() + theme(axis.text=element_text(size=14), axis.title=element_text(size=16)) + scale_color_manual(values=c("black", "gray"))
...
ggplot(data=c2, aes(x=time, y=c2, group=day, colour=factor(day))) + geom_line(size =2) + xlab("\nTime Index") + ylab("") + ylim(0,0.012) + theme_bw() + theme(axis.text=element_text(size=14), axis.title=element_text(size=16)) + scale_color_manual(values=c("black", "gray"))
...
ggplot(data=c3, aes(x=time, y=c3, group=day, colour=factor(day))) + geom_line(size =2) + xlab("\nTime Index") + ylab("") + ylim(0,0.012) + theme_bw() + theme(axis.text=element_text(size=14), axis.title=element_text(size=16)) + scale_color_manual(values=c("black", "gray"))
```
